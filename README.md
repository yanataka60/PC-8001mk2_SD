...
　PC-8001 N-BASIC V1.0の場合、MONITORに入ることでPC-8001_SDの初期化が行われるように拡張ROM用ソースコードを修正したため、今後コンパイルし直したときに該当コードが含まれるようになりますが、N-BASIC 1.0の時のみ有効になるのでPC-8001mk2_SDに影響はありません。
